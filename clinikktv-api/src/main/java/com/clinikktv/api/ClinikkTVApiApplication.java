package com.clinikktv.api;

import com.clinikktv.service.ServiceConfiguration;
...
public class ClinikkTVApiApplication {
    public static void main(String[] args) {
        SpringApplication.run(ClinikkTVApiApplication.class, args);
    }
}
